...
export default async function EnquiryDetailPage({
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <Link href="/admin/enquiries" className="inline-flex items-center gap-2 font-[family-name:var(--font-body)] text-xs text-[#6b7280] hover:text-[#9ca3af] transition-colors uppercase tracking-wider">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="font-[family-name:var(--font-body)] text-sm text-[#6b7280] mt-1">{enquiry.subject}</p>
        </div>
      ...
      <div className="flex flex-wrap gap-3">
        {enquiry.phone && (
          <a href={`tel:${enquiry.phone}`} className="inline-flex items-center gap-2 border border-white/[0.08] px-4 py-2 font-[family-name:var(--font-body)] text-xs font-bold uppercase tracking-wider text-[#9ca3af] hover:border-white/20 hover:text-[#e2e3e1] transition-colors">
        ...
        {waUrl && (
          <a href={waUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-white/[0.08] px-4 py-2 font-[family-name:var(--font-body)] text-xs font-bold uppercase tracking-wider text-[#9ca3af] hover:border-white/20 hover:text-[#e2e3e1] transition-colors">
            WhatsApp
          </a>
        )}
      </div>
