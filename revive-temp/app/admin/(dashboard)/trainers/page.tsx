    ...
    <div className="max-w-5xl space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="font-[family-name:var(--font-body)] text-sm text-[#6b7280] mt-0.5">{trainers?.length ?? 0} total</p>
        </div>
        <Link href="/admin/trainers/new" className="bg-[#ff571a] text-black font-[family-name:var(--font-body)] text-xs font-bold uppercase tracking-wider px-4 py-2 hover:bg-white transition-colors">+ New Trainer</Link>
      </div>
