...
export function LogoUploadSection({ currentLogoUrl }: { currentLogoUrl?: string | null }) {
  ...
  return (
    <section className="border border-white/[0.08] p-6 mb-6">
      <h2 className="font-[family-name:var(--font-body)] text-xs font-bold tracking-[0.15em] uppercase text-[#6b7280] mb-5">Brand Logo</h2>
      <div className="flex items-center gap-6 mb-5">
        ...
        <div>
          <p className="font-[family-name:var(--font-body)] text-sm text-[#e2e3e1] font-semibold mb-1">Current Logo</p>
          <p className="font-[family-name:var(--font-body)] text-xs text-[#6b7280] leading-relaxed">PNG, JPG, WebP or SVG · Max 2MB<br/>Recommended: 400 × 160px</p>
        </div>
      </div>
      <label className={`inline-flex items-center gap-2 cursor-pointer font-[family-name:var(--font-body)] text-xs font-bold tracking-[0.1em] uppercase px-5 py-2.5 border transition-colors ${
      ...
      {success && <p className="mt-3 text-xs text-emerald-400 font-[family-name:var(--font-body)]">✓ Logo updated. Refresh the site to see changes.</p>}
    </section>
  )
}
