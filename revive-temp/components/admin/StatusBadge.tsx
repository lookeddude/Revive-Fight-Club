...
type TrialStatus = 'pending' | 'contacted' | 'confirmed' | 'completed' | 'cancelled' | 'no_show'
  ...
  return (
    <span
      className={cn(
        ...
        'font-[family-name:var(--font-inter)] text-[11px] font-semibold uppercase tracking-wider',
        config.classes,
        className
      )}
    >
