  ...
  return (
    <>
      ...
      >
        {/* Updated flash */}
        {justUpdated && (
          <div className="absolute top-2 right-2 z-10 px-2 py-0.5 bg-green-500 text-black text-xs font-black uppercase tracking-wider">
            UPDATED
          </div>
        )}
        ...
        <div className="relative aspect-video w-full overflow-hidden bg-[#0a0b0a]">
          {currentUrl ? (
            ...
            <div className="w-full h-full flex flex-col items-center justify-center gap-2">
              ...
              <p className="font-[family-name:var(--font-body)] text-xs text-[#3a3530] uppercase tracking-wider">No Image Assigned</p>
            </div>
          )}
          {/* Section badge */}
          <div
            className="absolute top-2 left-2 px-2 py-0.5 text-xs font-black uppercase tracking-wider"
        ...
        <div className="p-3">
          ...
          {slot.description && (
            <p className="font-[family-name:var(--font-body)] text-sm text-[#4b5563] mt-0.5 leading-snug line-clamp-1">
              {slot.description}
            </p>
          )}
          <p className="font-[family-name:var(--font-body)] text-xs text-[#3a3530] mt-1 font-mono">
            {slot.slot_key}
          </p>
          {currentUrl && (
            <p className="font-[family-name:var(--font-body)] text-xs text-[#3a3530] mt-0.5 truncate">
        ...
        <div className="px-3 pb-3 flex gap-2">
          <button
            ...
            className="flex-1 py-2 bg-[#ff571a] text-black font-[family-name:var(--font-body)] text-xs font-black uppercase tracking-wider hover:bg-white transition-colors"
          >
          ...
          <button
            ...
            className="px-3 py-2 border border-white/[0.08] text-[#9ca3af] font-[family-name:var(--font-body)] text-xs font-bold uppercase tracking-wider hover:text-[#f0ede8] hover:border-white/20 transition-colors disabled:opacity-40"
            title="View history"
          >
            {loadingHistory ? '...' : (
