    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute inset-0"
          style={{
            background: 'linear-gradient(to bottom, rgba(14,12,16,0.65) 0%, rgba(14,12,16,0.20) 30%, rgba(14,12,16,0.35) 60%, rgba(14,12,16,0.95) 100%)',
          }}
          aria-hidden="true"
        />
        {/* Side vignettes */}
      ...
      {/* ── Main Content — anchored to lower third ── */}
      <div className="relative z-10 flex flex-col justify-end flex-1 max-w-[1320px] mx-auto w-full px-6 md:px-12 pb-12 md:pb-16">

        {/* Discipline eyebrow tags */}
        <div
          className={`flex flex-wrap items-center gap-x-3 gap-y-1 mb-5${entered ? ' hero-enter' : ''}`}
        ...
        >
          {disciplines.map((d, i, arr) => (
            <span key={d} className="flex items-center gap-3">
              <span
                className="font-[family-name:var(--font-body)] text-[11px] md:text-[12px] font-bold tracking-[0.22em] uppercase text-[#A0A0A8]"
              >
                {d}
              </span>
              {i < arr.length - 1 && (
        ...
        {/* Main heading — large, bold, uppercase */}
        <h1
          className={`font-[family-name:var(--font-outfit)] font-black uppercase text-[#FCFDFD] leading-[0.92] tracking-[-0.04em] mb-6${entered ? ' hero-enter' : ''}`}
          style={{
        ...
        {/* Tagline */}
        <p
          className={`font-[family-name:var(--font-body)] text-[#A0A0A8] mb-8${entered ? ' hero-enter' : ''}`}
          style={{
        ...
        {/* CTA Buttons */}
        <div
          className={`flex flex-col sm:flex-row items-stretch sm:items-center gap-3${entered ? ' hero-enter' : ''}`}
          style={entered ? ({ '--hero-delay': '380ms', '--hero-dur': '0.65s' } as React.CSSProperties) : undefined}
        >
          {/* Primary — white */}
          <Link
            href="/book-trial"
            className="inline-flex justify-center items-center font-[family-name:var(--font-body)] text-sm font-bold tracking-[0.1em] uppercase px-8 py-4 bg-[#FCFDFD] text-[#0E0C10] hover:bg-white hover:-translate-y-[2px] transition-all duration-200 active:scale-95 sm:w-auto"
          >
            ENROLL NOW
          </Link>
          ...
          {whatsappUrl ? (
            <a
              ...
              className="inline-flex justify-center items-center gap-2 font-[family-name:var(--font-body)] text-sm font-bold uppercase tracking-[0.1em] px-6 py-4 transition-all duration-200 active:scale-95 border border-[#25d366]/40 text-[#25d366] hover:bg-[#25d366]/8 sm:w-auto"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex justify-center items-center font-[family-name:var(--font-body)] text-sm font-bold uppercase tracking-[0.1em] px-6 py-4 transition-all duration-200 active:scale-95 border border-white/15 text-[#FCFDFD] hover:border-white/30 hover:bg-white/[0.04] sm:w-auto"
            >
              CONTACT US
            </Link>
          )}
