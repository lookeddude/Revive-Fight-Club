      ...
      <div className="relative z-10 flex flex-col justify-end flex-1 w-full px-5 sm:px-8 md:px-12 lg:px-16 pb-10 sm:pb-12 md:pb-14 lg:pb-16" style={{ paddingTop: 'clamp(52vh, 55vh, 60vh)' }}>
        ...
        <div style={{ maxWidth: '620px' }}>
          ...
          >
            ...
            <Link
              href="/book-trial"
              className="inline-flex justify-center items-center font-[family-name:var(--font-body)] text-[13px] font-bold tracking-[0.1em] uppercase px-7 py-3.5 bg-[#FCFDFD] text-[#0E0C10] hover:bg-white hover:-translate-y-[2px] transition-all duration-200 active:scale-95 sm:w-auto"
            >
              ENROLL NOW
            </Link>
            ...
            {whatsappUrl ? (
              <a
                ...
                className="inline-flex justify-center items-center gap-2 font-[family-name:var(--font-body)] text-[13px] font-bold uppercase tracking-[0.1em] px-6 py-3.5 transition-all duration-200 active:scale-95 border border-[#25d366]/40 text-[#25d366] hover:bg-[#25d366]/8 sm:w-auto"
              >
              ...
              <Link
                href="/contact"
                className="inline-flex justify-center items-center font-[family-name:var(--font-body)] text-[13px] font-bold uppercase tracking-[0.1em] px-6 py-3.5 transition-all duration-200 active:scale-95 border border-white/15 text-[#FCFDFD] hover:border-white/30 hover:bg-white/[0.04] sm:w-auto"
              >
                CONTACT US
              </Link>
            )}
